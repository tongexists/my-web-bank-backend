        ...
        FastAutoGenerator.create("jdbc:mysql://127.0.0.1:3306/my_web_bank?useSSL=false&useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai", "root", "root")
                .globalConfig(builder -> {
                    builder.author("tong") // 设置作者
                            ...
                            .outputDir("D:\\projects\\springboot-projects\\my-web-bank-backend"); // 指定输出目录
                })
...
//                            .moduleName("") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "D:\\projects\\springboot-projects\\my-web-bank-backend")); // 设置mapperXml生成路径
                })
                .strategyConfig(builder -> {
                    builder.addInclude("t_common_text") // 设置需要生成的表名
